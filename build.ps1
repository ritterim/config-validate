# Ref. https://github.com/devlead/BitbucketPipelinesShield/blob/4d5f08cbc15ffc975b4926e3060640995721c197/build.ps1

$CakeVersion = "0.29.0"
$DotNetChannel = "stable";
$DotNetVersion = "2.2.101";
$DotNetInstallerUri = "https://raw.githubusercontent.com/dotnet/cli/v2.2.101/scripts/obtain/dotnet-install.ps1";
...
& dotnet "$CakePath" $args --verbosity=diagnostic
exit $LASTEXITCODE
